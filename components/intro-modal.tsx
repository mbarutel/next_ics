...
export default function IntroModal() {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-60 overflow-y-auto h-full w-full flex justify-center items-center z-[9999]">
      <div className="bg-white/30 backdrop-blur-lg p-8 rounded-xl shadow-xl w-11/12 md:w-3/4 xl:w-70% border border-gray-300 flex flex-col justify-center items-center space-y-6">
        <p className="text-gray-800 text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-semibold text-center">
