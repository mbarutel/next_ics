  ...
  return (
    <footer>
      <div className="container">
        <div className="relative rounded-sm overflow-hidden flex flex-col px-6 pt-10 pb-7 bg-gradient-to-br gradient_secondary text-gray-700">
...
function Acknowledgement() {
  return (
    <div className="w-full order-1 sm:order-none">
      <h3 className="arvo uppercase font-bold tracking-tight md:text-lg lg:text-xl">
      ...
      <div className="flex gap-2">
        ...
        <p className="leading-tight w-[450px] text-sm">
