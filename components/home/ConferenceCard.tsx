...
export default function ConferenceCard(
  ...
  return (
    <div>
      <div
        className="bg-red-800/80 pt-1 sm:pt-2 px-1 sm:px-2 pb-2 sm:pb-4 rounded-t-lg mb-1"
      >
        <div className="relative mb-3 flex flex-col items-center">
          <Image
            ...
            className="h-36 sm:h-56 w-full rounded-lg object-cover shadow-lg contrast-75"
          />
      ...
      >
        <span
          className="w-full inline-flex items-center justify-center self-stretch px-4 py-2 text-sm text-white text-center font-bold uppercase transform transition-transform group-hover:translate-y-1 group-focus:translate-y-1 rounded-b-xl bg-red-800/80 active:scale-95"
        >
          Read More
        </span>
      </Link>
