    ...
    <div className="flex flex-col bg-gradient-to-b from-stone-950/90 to-red-950/90 px-2 py-6 sm:py-8 z-[99] text-white rounded-tr-xl rounded-bl-xl w-[min(90%,40rem)]">
      ...
      <div className="max-w-lg mx-auto flex justify-center items-center gap-4">
        ...
        <Link
          ...
          rel="noreferrer"
        >
          <span className="w-full inline-flex items-center justify-center self-stretch px-4 py-2 text-sm text-orange-500 text-center font-bold uppercase bg-white ring-1 ring-orange-500 ring-offset-1 transform transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
            Submit&nbsp;a&nbsp;paper
          </span>
        </Link>
      </div>
