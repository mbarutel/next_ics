...
function TitleAndSubTitle() {
  return (
    <div className="absolute flex_col left-5 top-1/2 xl:top-1/3 -translate-y-1/2 z-40">
      <h1 className="flex_col uppercase font-extrabold text-6xl w-fit">
      ...
      <Link
        href="/#conferences"
        className="rounded-md w-fit bg-gradient-to-r gradient px-7 py-4 mt-4 text-black uppercase hover:scale-105 active:scale-95 transition_config"
      >
        Conferences
      </Link>
    </div>
