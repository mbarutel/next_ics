  ...
  return (
    <section>
      <div className="section_container">
        <div className="flex flex-col lg:flex-row items-center bg-gradient-to-r gradient_secondary py-4 lg:py-14 lg:pl-12 lg:pr-14 xl:pr-16 2xl:pr-36 rounded-md justify-between">
