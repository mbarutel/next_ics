...
import ExhibitorForm from "@/sections/forms/exhibitors/exhibitor-form";
        ...
        <div className="container mx-auto w-[min(90%,960px)] py-8">
          <div className="form_section_wrapper text-center bg-stone-700 mb-4">
            ...
            <p className="text-white italic w-[min(100%,80ch)] mx-auto text-sm sm:text-base">
              Register your organization to exhibit at our upcoming conferences. Showcase your products and services to our attendees.
            </p>
          </div>
          <hr className="my-2" />
          <ExhibitorForm
